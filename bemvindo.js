            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    setTimeout(async function () {
                        ...
                        conn.sendMessage(anu.id, { image: {url: `https://p7api.xyz/api/card/welcomev2?nome=${anu.participants[0].split('@')[0]}&nomegp=BEM%20VINDO%20AO%20Grupo&titulo=BEM%20VINDO&membros=2022&cor=140000&tcor=062be0&lcor=FF7B00&perfil=${shortpc}&fundo=https://telegra.ph/file/5e7003ccc9cbaed903068.jpg&numero=2022&apikey=p7ori`}, "contextInfo": { mentionedJid: [numbreitu]},  caption: `Bem vindo(a) @${anu.participants[0].split('@')[0]}, leia as regras para não ser banido`})
                        } 
                    } else if(welkom.includes(anu.id)) {
                        imgperfil = await getBuffer(ppimg)
                        shortpc = await upload(imgperfil)                   
