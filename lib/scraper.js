...
function porno() {
    return new Promise((resolve, reject) => {
        ...
        .then((res) => {
            ...
            hasil.thumb = $('article > div.video-wrapper.vxplayer > div.vx_el').attr('data-poster') || '?random=1'
            ...
            hasil.video = $('article > div.video-wrapper.vxplayer > div.vx_el').attr('src') || $('article > div.video-wrapper.vxplayer > div.vx_el').attr('data-src') || '?random=1'
            resolve(hasil)
        })
    })
}
...
module.exports = { pinterest, wallpaper, wikimedia, porno, hentai, quotesAnime,  gpwhatsapp, hentaistube, nerding, apkmodhacker, xvideos, uptodown, pornhub, soundl, st, gpsrc, dafontSearch, dafontDown, igstalk,  apkmody }